...
public class LoggingAspect {
    ...
    @Before(value = "execution(* com.kgisl.sb1.service.PersonService.*(..))")
    ...
    @After(value = "execution(* com.kgisl.sb1.service.PersonService.*(..))")
    ...
    @AfterThrowing(pointcut = "execution(* com.kgisl.sb1.controller.*.*(..))", throwing = "excep")
